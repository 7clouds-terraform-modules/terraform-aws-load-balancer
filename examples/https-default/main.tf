module "load_balancer" {
  ...
  SECURITY_GROUP_INGRESS_BLOCK = [{SECURITY_GROUP_INGRESS_FROM_PORT = 443, SECURITY_GROUP_INGRESS_TO_PORT = 443, SECURITY_GROUP_INGRESS_RULES_PROTOCOL = "tcp", SECURITY_GROUP_INGRESS_CIDR_BLOCK = ["0.0.0.0/0"]}]
